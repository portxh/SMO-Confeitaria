...
class Categoria
{
    ...
    public function cadastrar()
    {
        ...
        $cmd = $con->prepare("INSERT INTO categorias (nm_categoria) 
        VALUES (:nm_categoria)");
    ...
    public function consultar()
    {
        ...
        $cmd = $con->prepare("SELECT * FROM categorias"); //comando SQL
    ...
    public function excluir()
    {
        ...
        $cmd = $con->prepare("DELETE FROM categorias  
    ...
    public function atualizar()
    {
        $con = Conexao::conectar(); //conectar no BD
        //comando SQL para cadastrar (INSERT)
        $cmd = $con->prepare("UPDATE categorias  SET
