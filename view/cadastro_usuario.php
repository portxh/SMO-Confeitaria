...
<body>
            ...
            <div class="col-sm-8 rounded border mx-auto p-3 shadow">
                ...
                <form action="<?php echo URL; ?>enviar-usuario" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="cpf" id="cpf" required placeholder="123.456.789-00" maxlength="14">
                    </div>
                    <div class="form-group">
                        <label for="celular">Celular:</label>
                        <input class="form-control" type="text" name="celular" id="celular" required placeholder="(00) 0000-0000" maxlength="15">
                    </div>
                    <div class="form-group">
                        <label for="email">E-mail</label>
                        <input type="email" name="email" id="email" placeholder="email@dominio.com" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label for="senha">Senha</label>
                        <input type="password" name="senha" id="senha" placeholder="•••••••••••••••" class="form-control" minlength="8" required>
                    </div>
                    <div class="form-group">
    ...
    <!-- Bootstrap JS -->
    <script src="./site/js/formatInputs.js"></script>
