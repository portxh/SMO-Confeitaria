                        ...
                        <tbody>
                            ...
                            foreach($dadosCategoria as $value)
                            {
                                echo "<tr>
                                        ...
                                        <td>
                                        <a href='". URL ."excluir-categoria/$value->cod_categoria' onclick='return confirm(\"Tem certeza?\")' class='btn btn-outline-danger btn-sm m-1'><i class='fa fa-trash'></i></a>
                                        <a href='". URL ."editar-categoria/$value->cod_categoria' class='btn btn-outline-warning btn-sm m-1'><i class='fa fa-edit'></i> </a>
                                    </td>
                                        </td>
                                    </tr>";
                            }
